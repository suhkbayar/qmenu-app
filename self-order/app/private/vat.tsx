...
const styles = StyleSheet.create({
  ...
  logo: { width: '100%', height: 110, alignSelf: 'center', marginBottom: 34 },
  subtitle: { fontSize: 20 },
  cardRow: { flexDirection: 'row', justifyContent: 'center', paddingHorizontal: 20 },
  centerRow: { flexDirection: 'row', justifyContent: 'center', marginVertical: 10 },
  card: {
    width: '22%', height: 180, backgroundColor: '#efefef',
    borderRadius: 16, margin: 12, elevation: 2, overflow: 'hidden',
  },
  activeCard: { backgroundColor: defaultColor },
  cardTouch: { flex: 1 },
  cardInner: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 18 },
  cardText: { fontSize: 20, fontWeight: 'bold', textAlign: 'center' },
  activeCardText: { color: 'white' },
  segmented: { marginTop: 8, width: '46%', borderRadius: 12 },
  segLabel: { fontSize: 18, fontWeight: 'bold' },
  segBtn: { borderRadius: 14, paddingVertical: 12, borderColor: 'transparent' },
  inputRow: { marginTop: 12, gap: 10, flexDirection: 'row', justifyContent: 'center', paddingHorizontal: 20 },
  inputWide: { width: '46%' },
  inputNarrow: { width: '30%' },
  footer: { flexDirection: 'row', justifyContent: 'space-between', position: 'absolute', bottom: 24, width: '100%', paddingHorizontal: 20 },
  backBtn: { paddingVertical: 20, paddingHorizontal: 28, borderRadius: 14 },
  backBtnText: { fontSize: 18, fontWeight: '700' },
  continueBtn: { backgroundColor: defaultColor, paddingVertical: 20, paddingHorizontal: 28, borderRadius: 14 },
  disabledBtn: { backgroundColor: '#f0f0f0' },
  continueBtnText: { color: 'white', fontSize: 18, fontWeight: '700' },
});
