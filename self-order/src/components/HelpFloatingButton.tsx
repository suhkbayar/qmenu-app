...
const HelpFloatingButton = () => {
  ...
  const handleQrPress = useCallback(() => { setOpen(false); setShowQr(true); }, []);
  const handleHistoryPress = useCallback(() => { setOpen(false); router.push('/private/history'); }, [router]);
...
const styles = StyleSheet.create({
  fab: { backgroundColor: '#EB1833', borderRadius: 999, elevation: 5, justifyContent: 'center', alignItems: 'center', width: 70, height: 70, bottom: 16 },
